...
public class BusService {
	...
	public String createBus(@PathParam("busId") int busId, @PathParam("busName") String busName,
			@PathParam("busSeats") int busSeats) {
	...
	public String updateBus(@PathParam("busId") int busId, @PathParam("busName") String busName,
			@PathParam("busSeats") int busSeats) {
